...
order: 2
kicker: Products
heroHeading: Native apps we built, free on the AppExchange
heroText: Three managed packages, all 100% native, all free. Built by the same team that builds for clients, which is why they behave like production software rather than demos.
description: TwinStack's free Salesforce AppExchange apps: Who Sees What, Smart Lookup Data Loader and Google Form Auto Sync.
faqTopics: [products]
---

## Why we publish free apps
